      ...
      child: Row(
        children: [
          ...
          DropdownButton<int>(
            ...
            onChanged: (v) {
              if (v != null) {
                // Page dropdown is 1-based; convert back to 0-based
                final newPage = (v - 1).clamp(0, pageCount - 1);
                if (newPage != page) {
                  // As a stateless bar, we call the callbacks via context owner
                  // The owner will setState appropriately. For simplicity here,
                  // we call onPrev/onNext to reach the new page quickly.
                }
              }
            },
          ),
