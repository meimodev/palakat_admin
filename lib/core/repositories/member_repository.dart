...
@riverpod
MemberRepository memberRepository(Ref ref) => MemberRepository(ref);

class MemberRepository {
  MemberRepository(this._ref);
  ...
  Future<MemberScreenStateCounts> fetchCounts(GetFetchAccountsRequest request) async {
    try {
      final http = _ref.read(httpServiceProvider);
      ...
      return MemberScreenStateCounts.fromJson(json);
